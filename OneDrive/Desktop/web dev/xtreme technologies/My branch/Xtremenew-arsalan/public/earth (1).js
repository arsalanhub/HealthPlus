...
(function () {
    ...
    function drawLocationMark(point, coord) {
      ...
      if (coord && _.isFinite(coord[0]) && _.isFinite(coord[1])) {
        ...
        d3.select("#foreground")
          ...
          .attr(
            "xlink:href",
            "https://img.icons8.com/material-rounded/344/ffffff/tsunami--v4.png" //tsunami (new icon)
          )
          .attr("width", 30)
          .attr("height", 30);
        ...
        d3.select("#foreground")
          ...
          .attr(
            "xlink:href",
            "https://cdn-icons-png.flaticon.com/512/4053/4053762.png" //sandstorm (new icon)
          )
          .attr("width", 30)
          .attr("height", 30);
        ...
        d3.select("#foreground")
          ...
          .attr(
            "xlink:href",
            "https://cdn-icons-png.flaticon.com/512/3445/3445722.png" //storm (new icon)
          )
          .attr("width", 30)
          .attr("height", 30);
        ...
        d3.select("#foreground")
          ...
          .attr(
            "xlink:href",
            "https://cdn3.iconfinder.com/data/icons/weather-set-color/512/gale-storm-wind-weather-forecast-strong-strongwind-512.png" //gale (old icon)
          )
          .attr("width", 30)
          .attr("height", 30);
        ...
        d3.select("#foreground")
          ...
          .attr(
            "xlink:href",
            "https://cdn-icons-png.flaticon.com/512/6631/6631648.png" //hurricane (new icon)
          )
          .attr("width", 30)
          .attr("height", 30);
        // Tsunami selected
  ...
  function animate(globe, field, grids) {
    ...
    // if (configuration.attributes.level === "waves") g.lineWidth = 5.0;
  ...
  function drawOverlay(field, overlayType) {
    ...
    if (overlayType) {
      if (overlayType === "move") {
        // let overlayctx = ctx.putImageData(0, 0, 256, 256);
        // ctx.putImageData(overlayctx, 0, 0);
        // µ.clearCanvas(d3.select("#overlay").node());
        // let overlayctx = d3.select("#overlay").node().getContext("2d");
