  ...
  .on("value", function (snapshot) {
    ...
    snapshot.forEach(function (childSnapshot) {
      ...
      <div class="card-container">
                ...
                <img class="round" src="https://intentplanning.ca/wp-content/uploads/2019/01/sample-person.jpg" width="50%%"
                    alt="user" />
    ...
    snapshot.forEach(function (childSnapshot) {
      ...
      for (let i = 0; i < doc_btn.length; i++) {
        ...
        doc_btn[i].onclick = function () {
          ...
          else if (slot === "2:00") pos = 2;
          else if (slot === "5:00") pos = 3;
          else if (slot === "9:00") pos = 4;
          else if (slot === "11:00") pos = 5;
